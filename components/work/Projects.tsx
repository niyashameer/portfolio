...
const Projects = () => {
	...
	return (
		<div className='h-screen w-full relative overflow-hidden' ref={emblaRef}>
			<div className='w-max text-lightBlack font-bold text-4xl font-lightBlack pt-14 px-14'>
				projects
			</div>
			<div className='flex justify-center items-center h-[80%]'>
				<div className='h-[60%] w-full flex flex-col items-center justify-center place-content-center'>
